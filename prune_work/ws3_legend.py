"""WS3 legend overlay (run in cue_openfold_gated): load ws3_raw.png + summary.json, add a color
legend + TM-score title -> ws3_final.png.
...
img = mpimg.imread(f"{out_dir}/ws3_raw.png")
...
ax.set_title(
    ...
    fontsize=13)
plt.tight_layout()
plt.savefig(f"{out_dir}/ws3_final.png", dpi=150, bbox_inches="tight")
print(f"wrote {out_dir}/ws3_final.png")
