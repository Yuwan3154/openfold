...
def _flash_attn(q, k, v, kv_mask):
    ...
    kv_unpad_result = unpad_input(kv, kv_mask)
    if len(kv_unpad_result) == 4:
        kv_unpad, _, kv_cu_seqlens, kv_max_s = kv_unpad_result
    else:
        kv_unpad, _, kv_cu_seqlens, kv_max_s, _ = kv_unpad_result
